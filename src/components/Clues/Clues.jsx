...
function Clues() {
    ...
    return (
        <div className="clues">
            ...
            <button onClick={() => viewClue(stateValues[0], pokemonData.habitat, stateValues[1])} className={`clues__buttontwo clues__button clues__button--${stateButtonTwo}`}>HABITAT</button>
